...
public class Repo extends Repository {
    ...
    public static void checkoutToSpecificCommitID(String commitID, String branch) {
        ...
        writeContents(join(BRANCH_DIR, branch), commitID);
    ...
    public static void reset(String commitID) {
        ...
        for (String file : fileList) {
            if (file.contains(commitID)) {
                String currentBranch = readContentsAsString(HEAD_DIR);
                checkoutToSpecificCommitID(file, currentBranch);
                return;
            }
        }
        System.out.println("No commit with that id exists.");
